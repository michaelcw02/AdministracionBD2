...
rem sqlplus /nolog @C:\bd2\Droppear_funciones.sql %Val2%

rem script que genera dinamicamente un script para crear vistas
sqlplus /nolog @C:\bd2\sistema5.sql CON

rem invoca vistas
sqlplus /nolog @C:\bd2\Crear_vistas.sql %Val2%
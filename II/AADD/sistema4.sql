...
spool C:\bd2\Crear_funciones.sql
set pagesize 0
set linesize 300
set feedback off
set termout off
...
select 'create or replace function fun_'||table_name||' return number is '||chr(10)||
'VCant number; '||chr(10)||
'begin'||chr(10)||
'select count(*) into VCant from SISTEMA.'||table_name||';'||chr(10)||
'return VCant;'||chr(10)||
'end fun_'||table_name||';'||chr(10)||
'/'
from   dba_tables
where  owner='SISTEMA'
